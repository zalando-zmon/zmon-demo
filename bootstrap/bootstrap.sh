...
run_docker zmon-notification-service \
    ...
    -e NOTIFICATIONS_GOOGLE_PUSH_SERVICE_API_KEY="$(cat /workdir/.google_key)" \
...
run_docker zmon-worker \
    ...
    -e WORKER_NOTIFICATION_SERVICE_URL=http://zmon-notification-service:8087/ \
    -e WORKER_NOTIFICATION_KEY=$WORKER_TOKEN \
    $ZMON_WORKER_IMAGE
